...
var TranslocoDirective = class _TranslocoDirective {
  ...
  static ɵdir = ɵɵdefineDirective({
    ...
    selectors: [["", "transloco", ""]],
    inputs: {
      key: [InputFlags.None, "transloco", "key"],
      params: [InputFlags.None, "translocoParams", "params"],
      inlineScope: [InputFlags.None, "translocoScope", "inlineScope"],
      inlineRead: [InputFlags.None, "translocoRead", "inlineRead"],
      inlineLang: [InputFlags.None, "translocoLang", "inlineLang"],
      inlineTpl: [InputFlags.None, "translocoLoadingTpl", "inlineTpl"]
    },
    standalone: true,
